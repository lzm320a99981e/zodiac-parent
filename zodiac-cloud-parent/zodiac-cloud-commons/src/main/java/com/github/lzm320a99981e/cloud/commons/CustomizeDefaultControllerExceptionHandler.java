 ...
 * 默认控制层异常处理器
 */
public class CustomizeDefaultControllerExceptionHandler implements CustomizeControllerExceptionHandler {
    private final ValidationExceptionHandler validationExceptionHandler;

    public CustomizeDefaultControllerExceptionHandler(ValidationExceptionHandler validationExceptionHandler) {
